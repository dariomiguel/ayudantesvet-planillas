...
docker build -f DockerfileTomcat -t planillasvet .
```
...
# Instancia y ejecuta un contendor en base a la imagen "planillasvet". 
docker run -p 8080:8080 planillasvet 

# Ejecuta un contendor ya instanciado.
docker start <containerId> 

# Instancia un contendor en base a la imagen planillasvet para ejecutar bash.
docker run -it --entrypoint /bin/bash planillasvet
