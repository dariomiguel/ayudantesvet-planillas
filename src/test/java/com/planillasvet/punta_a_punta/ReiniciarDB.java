package com.planillasvet.punta_a_punta;
...
public class ReiniciarDB {
    public static void limpiarBaseDeDatos()
    {
        try {
            ...
            String dbName = System.getenv("DB_NAME") != null ? System.getenv("DB_NAME") : "planillasvet";
            ...
            String comando = String.format(
                "docker exec planillasvet-mysql mysql -h %s -P %s -u %s -p%s %s -e \"%s\"",
