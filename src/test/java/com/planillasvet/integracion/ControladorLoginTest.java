package com.planillasvet.integracion;

import com.planillasvet.integracion.config.HibernateTestConfig;
import com.planillasvet.integracion.config.SpringWebTestConfig;
...
public class ControladorLoginTest {
	...
	public void debeRetornarLaPaginaLoginCuandoSeNavegaALLogin() throws Exception {
		...
		assertThat(modelAndView.getModel().get("datosLogin").toString(),  containsString("com.planillasvet.presentacion.DatosLogin"));
